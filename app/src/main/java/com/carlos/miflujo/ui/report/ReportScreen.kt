...
private fun ExpenseDetailCurrencySection(
    ...
    Column(
        ...
        Column(
            ...
            BreakdownLine(
                label = "Agua",
                value = "$currencySymbol ${breakdown.waterMinor.formatMoneyMinor()}",
                indented = true,
            )
            BreakdownLine(
                label = "Luz",
                value = "$currencySymbol ${breakdown.electricityMinor.formatMoneyMinor()}",
                indented = true,
            )
            BreakdownLine(
                label = "Internet",
                value = "$currencySymbol ${breakdown.internetMinor.formatMoneyMinor()}",
                indented = true,
            )
        }
    }
